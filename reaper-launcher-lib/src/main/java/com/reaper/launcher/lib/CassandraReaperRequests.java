...
public class CassandraReaperRequests {
    ...
    @Deprecated
    public static String createRepair(String nodeIp, String clusterName, String keyspace, Integer repairThreadCount, Boolean incrementalRepair, String reaperJobOwner) {
        ...
        try {
            ...
            if (!uuid.isEmpty()) {
                ...
                throw new ReaperLauncherException("The uuid is empty. You need to reconnect to the cluster through the command '> ./run.sh  -connect  cassandra-reaper-ip  cassandra-entry-point'.");
            }
        } catch (Exception e) {
    ...
    @Deprecated
    public static void deleteRepair(String nodeIp, String uuid, String reaperJobOwner) {
